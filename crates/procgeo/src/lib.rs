...
pub mod prelude {
    ...
    pub use procgeo_core::{
        AttribClass, AttribDefault, AttribHandle, AttribValue, Geometry, PointHandle, PolyType,
        PrimHandle, TypeQualifier, VertexHandle,
    };
    pub use procgeo_sops::{GeometryExt, Sop, SopError, generate};
