...
impl Sop for AttribPromoteSop {
    ...
    fn execute(&self, inputs: &[&Geometry], params: &Self::Params) -> Result<Geometry, SopError> {
        ...
        let is_vec3 = geo
            .find_attrib::<[f32; 3]>(params.from_class, &params.name)
            .is_ok()
            && geo
                .find_attrib::<f32>(params.from_class, &params.name)
                .is_err();
...
fn build_float_dst_values(
    ...
    let result = match (from_class, to_class) {
        // Point -> Primitive
        (AttribClass::Point, AttribClass::Primitive) => (0..to_count)
            .map(|prim_idx| {
...
fn build_vec3_dst_values(
    ...
    let result = match (from_class, to_class) {
        ...
        (AttribClass::Primitive, AttribClass::Point) => {
            ...
            accum
                .iter()
                .map(|vals| aggregate_vec3(vals, method))
                .collect()
        }
...
mod tests {
    ...
    fn promote_point_to_prim_avg() {
        ...
        let handle = result
            .find_attrib::<f32>(AttribClass::Primitive, "val")
            .unwrap();
    ...
    fn promote_point_to_detail() {
        ...
        let handle = result
            .find_attrib::<f32>(AttribClass::Detail, "val")
            .unwrap();
    ...
    fn promote_min_max() {
        ...
        let h_min = min_result
            .find_attrib::<f32>(AttribClass::Primitive, "val")
            .unwrap();
        let h_max = max_result
            .find_attrib::<f32>(AttribClass::Primitive, "val")
            .unwrap();
    ...
    fn promote_vector3() {
        ...
        let handle = geo
            ...
            .unwrap();
        for i in 0..geo.num_points() {
            geo.set_attrib(&handle, i, [i as f32, i as f32 * 2.0, i as f32 * 3.0])
                .unwrap();
        }
        ...
        let h = result
            .find_attrib::<[f32; 3]>(AttribClass::Primitive, "vel")
            .unwrap();
    ...
    fn promote_detail_to_point() {
        ...
        let dh = geo
            .find_attrib::<f32>(AttribClass::Detail, "scale")
            .unwrap();
        ...
        let h = result
            .find_attrib::<f32>(AttribClass::Point, "scale")
            .unwrap();
